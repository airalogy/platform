...
- independent advisory Reviewer Agent, bounded parallel and dependent read-only Tool graphs, and bounded mixed Tool/Resource/Instrument/External Service/Compute/Wait graphs (delivered); Protocol/Human graph nodes, arbitrary multi-agent execution, and reproduction evaluation
