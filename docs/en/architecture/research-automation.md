...
- independent advisory Reviewer Agent, bounded parallel and dependent read-only Tool graphs, and bounded mixed Protocol/Tool/Resource/Instrument/External Service/Compute/Wait graphs (delivered); generic Human Work Item graph nodes, arbitrary multi-agent execution, and reproduction evaluation
