...
- independent advisory Reviewer Agent, bounded parallel and dependent read-only Tool graphs, and bounded mixed Tool/Resource/Instrument/Compute/Wait graphs (delivered); Protocol/Human/External Service graph nodes, arbitrary multi-agent execution, and reproduction evaluation
