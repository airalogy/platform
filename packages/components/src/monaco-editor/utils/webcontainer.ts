import type { DataNode, DirectoryInterface, FileInterface } from "../types"
import type { FileSystemTree, WebContainer } from "../types/fileSystem"
...
function routerFormat(path: string): string {
...
export async function rm(path: string, webcontainerInstance: WebContainer) {
