...
export async function getDirectory(id?: string): Promise<DirectoryInterface | null> {
...
export async function directoryDataFormatter(handler: FileSystemDirectoryHandle | FileSystemFileHandle, path: string = "", children?: (FilerInterface | DirectoryInterface)[]): Promise<FilerInterface | DirectoryInterface> {
  const id = nanoid()
...
export async function getDirectoryHandlerDeep(directoryHandler: FileSystemDirectoryHandle, path: string = ""): Promise<DirectoryInterface> {
...
export function clearCurDirectory() {
  curDirectory = null
}
