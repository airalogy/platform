  ...
  return (
    ...
    >
      <button
        ...
        className={`text-lightgray text-[ flex items-center border-none bg-transparent pl-0 text-xs${vscForeground}] cursor-pointer outline-none hover:brightness-125`}
        onClick={onClick}
      >
