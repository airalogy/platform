...
const PLUGIN_KEY = "add-variable-to-content"
export const AddVariableToContentPluginKey = new PluginKey(PLUGIN_KEY)

export const AddVariableToContent = Node.create<MentionOptions>({
  name: PLUGIN_KEY,
  ...
  addOptions() {
    return {
      ...
      suggestion: {
        char: "#",
        pluginKey: AddVariableToContentPluginKey,
        allow: ({ state, range }) => {
