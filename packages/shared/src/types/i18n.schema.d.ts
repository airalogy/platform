  ...
  interface Schema {
    ...
    page: {
      ...
      workflowAnalysis: {
        ...
        computeExcluded: string
        computeContractHint: string
        computeResultContract: string
        computeSchemaHint: string
        computePortsHint: string
        computeResultPath: string
        nullableOutput: string
        requiredOutput: string
        noScalarOutputs: string
        changeMethodHint: string
        runComputeGovernance: string
        taskOwnerApprover: string
        computeGovernance: string
        exactEnvironmentHint: string
        computeRevisionError: string
        outputType: string
        invalidComputeSelection: string
      ...
      workflowDefinitions: {
        ...
        backToEdit: string
        confirmSave: string
        runGovernance: string
        researchTask: string
        selectTask: string
        noCompatibleTask: string
      ...
      analysis: {
        ...
        ai: {
          draftTitle: string
          computeDraftTitle: string
          computeDraftDisclosure: string
          computeDraftGenerate: string
          computeDraftDetails: string
          computeScopeMismatch: string
          computeAdoptedHint: string
          computeInterpretationTitle: string
          computeInterpretationDisclosure: string
          computeInterpretationGenerate: string
          continueManually: string
          computeManualHint: string
          groundingRejected: string
          interpretationTitle: string
          draftDisclosure: string
          interpretationDisclosure: string
          draftGenerate: string
          interpretationGenerate: string
          ...
          interpretationDisclaimer: string
          ...
          errors: {
            ...
            invalid_proposal: string
            model_unavailable: string
            generation_interrupted: string
            ai_disabled: string
            context_changed: string
            source_access_changed: string
          }
        }
        ...
        warnings: {
          missing_values_excluded: string
          invalid_values_excluded: string
          invalid_filter_values_excluded: string
        }
      }
      knowledge: {
        editMetadata: string
        ...
        visibilityLab: string
        visibilityProject: string
        ...
        knowledgeBodyPlaceholder: string
