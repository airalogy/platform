...
from .research_compute_jobs import router as research_compute_jobs_router
from .research_compute_jobs import (
    runtime_router as research_compute_jobs_runtime_router,
)
...
app.include_router(research_compute_jobs_router)
app.include_router(research_compute_jobs_runtime_router)
...
app.include_router(instrument_packages_router)
