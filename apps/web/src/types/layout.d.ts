...
/** Header config */
interface AIRALayoutHeaderConfig {
  /**
...
/** Sider config */
interface AIRALayoutSiderConfig {
  /**
...
/** Content config */
export interface AIRALayoutContentConfig {
  /**
   * Content class
   *
   * @default ''
...
/** Footer config */
export interface AIRALayoutFooterConfig {
  /**
...
/** Admin layout props */
export interface AIRALayoutProps
  extends AIRALayoutHeaderConfig,
  AIRALayoutTabConfig,
  AIRALayoutSiderConfig,
  AIRALayoutContentConfig,
  AIRALayoutFooterConfig {
  /**
   * Layout mode
   *
   * - {@link LayoutMode}
   ...
   *   ```ts
   *   import { AIRALayoutScrollElId } from '@sa/vue-materials';
   *   ```
   *
   * @default
   * ```ts
   * const AIRALayoutScrollElId = '__ADMIN_LAYOUT_SCROLL_EL_ID__'
   * ```
   */
  scrollElId?: string
  ...
  maxWidth?: number
  /**
   * Whether the layout is container
   *
   * @default true
   */
  isContainer?: boolean
...
export interface PageTabProps {
  /** Whether is dark mode (DEPRECATED - always false, dark mode has been removed) */
  darkMode?: boolean
  /**
   * The mode of the tab
   *
